...
leftTitle.innerHTML = `Sip, Savor, Smile. <span class="italic-accent">It’s coffee time!</span>`
const socialLinks = document.createElement('div');
socialLinks.classList.add('social-block');
const tw = document.createElement('a');
tw.classList.add('social-icon');
tw.href = 'https://twitter.com/';
tw.target = '_blank';
tw.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
ins.classList.add('social-icon');
ins.href = 'https://www.instagram.com/';
ins.target = '_blank';
ins.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
face.classList.add('social-icon');
face.href = 'https://www.facebook.com/';
face.target = '_blank';
face.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
rightBlock.classList.add('footer-block', 'right-block');
const rightTitle = document.createElement('h2');
rightTitle.classList.add('right-title');
rightTitle.textContent = 'Contact us';
const rightContacts = document.createElement('ul');
rightContacts.classList.add('contacts-list');

const address = document.createElement('li');
address.classList.add('contacts-link');
const iconAddress = document.createElement('svg');
iconAddress.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
...
linkAddress.href = 'https://www.google.com/maps?q=8558+Green+Rd.,+LA';
linkAddress.target = '_blank';

const tel = document.createElement('li');
tel.classList.add('contacts-link');
const iconTel = document.createElement('svg');
iconTel.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
...
linkTel.href = 'tel:+16035550123';

const timeToWork = document.createElement('li');
...
linkTime.classList.add('time-link');
linkTime.textContent = `Mon-Sat: 9:00 AM – 23:00 PM`;

socialLinks.append(tw, ins, face);
leftBlock.append(leftTitle, socialLinks);
address.append(iconAddress, linkAddress);
tel.append(iconTel, linkTel);
timeToWork.append(iconTime, linkTime);
rightContacts.append(address, tel, timeToWork);
