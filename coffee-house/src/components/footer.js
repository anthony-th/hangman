...
address.href = 'https://www.google.com/maps?q=8558+Green+Rd.,+LA';
...
const linkTel = document.createElement('p');
...
const linkTime = document.createElement('p');
